...
namespace BusinessLogicLayer
{
    public class clsTestAppointment
    {
        ...
        private bool _AddNewTestAppointment()
        {
            ...
            this.TestAppointmentID = clsTestAppointmentData.AddNewAppointment((int)this.TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        public static clsTestAppointment Find(int testAppointmentID)
        {
            ...
            if (clsTestAppointmentData.GetTestAppointmentWithTestAppointmentID(testAppointmentID, ref testTypeID, ref localDrivingLicenseApplicationID,
